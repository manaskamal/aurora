...
; 219  : void au_free_page(void* ptr, int pages) {
...
; 221  : 		x86_64_paging_free((uint64_t)ptr + i * 4096);
...
; 206  : 	uint64_t page_ = (uint64_t)page;
...
; 208  : 		x86_64_map_page((uint64_t)x86_64_pmmngr_alloc(), (uint64_t)(page_ + i * 4096), 0);
