...
; File e:\aurora kernel\kernel\utils\list.cpp
_TEXT	SEGMENT
current_index$1 = 0
current_node$ = 8
tv75 = 16
...
; 67   : void * list_get_at(list_t* list, unsigned int index) {
...
; 68   : 
; 69   : 	if (list->pointer == 0 || index >= list->pointer)
...
; 71   : 
; 72   : 	dataentry * current_node = list->entry_current;
...
; 73   : 
; 74   : 	for (unsigned int current_index = 0; (current_index < index) && current_node; current_index++)
...
; 75   : 		current_node = current_node->next;
...
; 76   : 
; 77   : 	return current_node ? current_node->data : nullptr;
...
; 80   : void* list_remove(list_t* list, unsigned int index) {
...
; 82   : 	void* payload;
; 83   : 
; 84   : 	if (list->pointer == 0 || index >= list->pointer)
...
; 95   : 
; 96   : 	if (current_node->prev)

	mov	rax, QWORD PTR current_node$[rsp]
	cmp	QWORD PTR [rax+8], 0
	je	SHORT $LN3@list_remov

; 97   : 		current_node->prev->next = current_node->next;
...
; 98   : 
; 99   : 	if (current_node->next)

	mov	rax, QWORD PTR current_node$[rsp]
	cmp	QWORD PTR [rax], 0
	je	SHORT $LN2@list_remov

; 100  : 		current_node->next->prev = current_node->prev;
...
; 103  : 		list->entry_current = current_node->next;
...
; 45   : void list_add(list_t* list, void* data) {
...
; 46   : 	dataentry *current_data = (dataentry*)kmalloc(sizeof(dataentry));

	mov	ecx, 24
	call	kmalloc
	mov	QWORD PTR current_data$[rsp], rax

; 47   : 	current_data->next = 0;

	mov	rax, QWORD PTR current_data$[rsp]
	mov	QWORD PTR [rax], 0

; 48   : 	current_data->prev = 0;

	mov	rax, QWORD PTR current_data$[rsp]
	mov	QWORD PTR [rax+8], 0

; 49   : 	current_data->data = data;
...
; 50   : 
; 51   : 
; 52   : 	if (!list->entry_current) {

	mov	rax, QWORD PTR list$[rsp]
	cmp	QWORD PTR [rax+8], 0
	jne	SHORT $LN4@list_add

; 53   : 		list->entry_current = current_data;
...
; 56   : 		dataentry * current_entry = list->entry_current;
...
; 57   : 		while (current_entry->next) {

	mov	rax, QWORD PTR current_entry$1[rsp]
	cmp	QWORD PTR [rax], 0
	je	SHORT $LN1@list_add

; 58   : 			current_entry = current_entry->next;
...
; 60   : 		current_entry->next = current_data;

	mov	rax, QWORD PTR current_entry$1[rsp]
	mov	rcx, QWORD PTR current_data$[rsp]
	mov	QWORD PTR [rax], rcx

; 61   : 		current_data->prev = current_entry;
...
; 37   : list_t* initialize_list() {

$LN3:
	sub	rsp, 56					; 00000038H

; 38   : 	list_t *list = (list_t*)kmalloc(sizeof(list_t));

	mov	ecx, 16
	call	kmalloc
	mov	QWORD PTR list$[rsp], rax

; 39   : 	list->entry_current = 0;
